            ...
            <div className={clsx(styles.home_hero)}>
              <div className={clsx(styles.home_hero_info)}>
                ...
                <div className={clsx(styles.home_hero_info_des)}>
                  ...
                  <p>
                    Випускники даних спеціальностей підготовлені до ремонтно-експлуатаційної, виробничої та організаційної діяльності, що забезпечує широкий спектр можливостей для працевлаштування.
                  </p>
                </div>
              </div>
            </div>
